...
export const playerApi = {
  ...
  listMatchHistory: (): Promise<PlayerMatchHistoryDto> => invoke("matches:history"),
  getMatchHistoryResult: (matchId: string): Promise<PlayerMatchResultDto> => invoke("matches:result", matchId),
